...
/**
 * FloatingPlatforms icon from Game Icons
 * @module
 */
export function GiFloatingPlatforms(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default GiFloatingPlatforms;
