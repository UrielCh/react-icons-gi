...
/**
 * AcousticMegaphone icon from Game Icons
 * @module
 */
export function GiAcousticMegaphone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default GiAcousticMegaphone;
