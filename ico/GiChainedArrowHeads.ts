...
/**
 * ChainedArrowHeads icon from Game Icons
 * @module
 */
export function GiChainedArrowHeads(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default GiChainedArrowHeads;
