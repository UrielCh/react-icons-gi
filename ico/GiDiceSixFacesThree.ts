...
/**
 * DiceSixFacesThree icon from Game Icons
 * @module
 */
export function GiDiceSixFacesThree(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default GiDiceSixFacesThree;
