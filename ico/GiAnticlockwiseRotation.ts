...
/**
 * AnticlockwiseRotation icon from Game Icons
 * @module
 */
export function GiAnticlockwiseRotation(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default GiAnticlockwiseRotation;
