...
/**
 * MachineGunMagazine icon from Game Icons
 * @module
 */
export function GiMachineGunMagazine(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default GiMachineGunMagazine;
