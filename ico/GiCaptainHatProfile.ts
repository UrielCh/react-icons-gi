...
/**
 * CaptainHatProfile icon from Game Icons
 * @module
 */
export function GiCaptainHatProfile(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default GiCaptainHatProfile;
