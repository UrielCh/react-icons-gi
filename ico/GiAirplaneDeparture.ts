...
/**
 * AirplaneDeparture icon from Game Icons
 * @module
 */
export function GiAirplaneDeparture(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default GiAirplaneDeparture;
